...
This data package contains the data that powers the chart ["CO₂ emissions from fossil fuels and land-use change"](https://ourworldindata.org/grapher/co2-fossil-plus-land-use?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
...
#### Full citation
Global Carbon Budget (2025) – with major processing by Our World in Data. “Total (fossil fuels and land-use change)” [dataset]. Global Carbon Project, “Global Carbon Budget v15” [original data].
...
#### Full citation
Global Carbon Budget (2025) – with major processing by Our World in Data. “Land-use change” [dataset]. Global Carbon Project, “Global Carbon Budget v15” [original data].
Source: Global Carbon Budget (2025) – with major processing by Our World In Data
...
#### Full citation
Global Carbon Budget (2025) – with major processing by Our World in Data. “Fossil fuels” [dataset]. Global Carbon Project, “Global Carbon Budget v15” [original data].
Source: Global Carbon Budget (2025) – with major processing by Our World In Data
